...
const Header = () => {
  ...
  return (
    <Container
      className={cn(
        "flex w-full items-center justify-between fixed left-1/2 -translate-x-1/2 top-0 z-30   transition-colors duration-300 ease-in-out h-20 backdrop-contrast-125",
        pathname !== "/"
