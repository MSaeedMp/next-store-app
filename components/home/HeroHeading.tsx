const HeroHeading = () => {
  return (
    <h1
      className="absolute xl:left-[100px] sm:left-[50px] left-[20px] md:left[70px] text-stone-200 xl:top-[510px] top-[290px] md:top-[380px] lg:top-[525px] text-5xl sm:text-7xl sm:top-[450px] md:text-8xl font-bold tracking-tight z-20 leading-[1.2]"
